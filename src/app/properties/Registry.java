...
public final class Registry {
    ...
    static {
        String pth = "/" + Registry.class.getPackage().toString().substring(8).trim().replace('.', '/');
        
        loadPropTypesMap(pth + "/resources/props.types.ini");
        loadPropsAbbrevationsMap(pth + "/resources/props.abbreviations.ini");
        loadProps4ResultFiles(pth + "/resources/props.results.filenames.ini");
        loadProps4ResultDirectories(pth + "/resources/props.results.dirnames.ini");
    }
    ...
    public static void loadPropTypesMap(String path) {
        ...
        Logger.getLogger(Registry.class.getName()).log(Level.INFO, "Loading properties from \"" + path + "\"");
    ...
    /**
     * Returns a boolean value denoting weather the property name and value must
     * be used for the output results file. Note that if not specified, the
     * default value returned is false.
     *
     * @param propName
     *
     * @return true if the property name and value must be used for the output
     * results file or false if otherwise or unspecified.
     */
    ...
    /**
     * Returns a boolean value denoting weather the property name and value must
     * be used for the output results directory. Note that if not specified, the
     * default value returned is false.
     *
     * @param propName
     *
     * @return true if the property name and value must be used for the output
     * results directory or false if otherwise or unspecified.
     */
